...
public class LibraryApplication {
	...
	CommandLineRunner runner() {
		return args -> {
			...
			User user1 = new User("admin", pwEncoder.encode("test"), "martijn.reede@gmail.com", "admin", "dheeraj", "vijayawada", "0611433823", "AP");
			user1.setRole("ROLE_ADMIN");
			
			User user2 = new User("employee", pwEncoder.encode("test"), "cyrille.jones@gamail.com", "Satya", "Murthy", "Hugo de Grootstraat 174", "06-87054875", "Sliedrecht");
			user2.setRole("ROLE_EMPLOYEE");
			
			User user3 = new User("user", pwEncoder.encode("test"), "vishwa@gmail.com", "vishwa", "teja", "khammam", "068756892", "hyderabad");
			user3.setRole("ROLE_USER");	

			User user4 = new User("user3", pwEncoder.encode("test"), "annemie.schuurbiers@gmail.com", "vishwa", "manda", "Duinerlaan 173", "06-83472443", "Eelde");
			user4.setRole("ROLE_USER");
			User user5 = new User("user2", pwEncoder.encode("test"), "vishwa@gmail.com", "vishwa", "manda", "khammam2", "068756892", "hyderabad1");
